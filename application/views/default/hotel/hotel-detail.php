					...
					<div class="row">
						...
						<div class="col-lg-9">
							...
							<div class="owl-carousel owl-theme carousel-thumbs-2 magnific-gallery">
								<div class="item">
									<a href="img/carousel/1.jpg" data-effect="mfp-zoom-in"><img src="<?php echo base_url(); ?>assets/default/img/carousel/1.jpg" alt="Image">
									</a>
								</div>
								<div class="item">
									<a href="img/carousel/2.jpg" data-effect="mfp-zoom-in"><img src="<?php echo base_url(); ?>assets/default/img/carousel/2.jpg" alt="Image">
									</a>
								</div>
								<div class="item">
									<a href="img/carousel/3.jpg" data-effect="mfp-zoom-in"><img src="<?php echo base_url(); ?>assets/default/img/carousel/3.jpg" alt="Image">
									</a>
								</div>
								<div class="item">
									<a href="img/carousel/4.jpg" data-effect="mfp-zoom-in"><img src="<?php echo base_url(); ?>assets/default/img/carousel/4.jpg" alt="Image">
									</a>
								</div>
							</div>
							<!-- End photo carousel  -->
					...
					<div class="row">
						...
						<div class="col-lg-9">
							...
							<div class="review_strip_single">
								<img src="<?php echo base_url(); ?>assets/default/img/avatar1.jpg" alt="Image" class="rounded-circle">
							...
							<div class="review_strip_single">
								<img src="<?php echo base_url(); ?>assets/default/img/avatar2.jpg" alt="Image" class="rounded-circle">
								<small> - 10 March 2015 -</small>
								<h4>Jhon Doe</h4>
								<p>
									"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
							...
							<div class="review_strip_single last">
								<img src="<?php echo base_url(); ?>assets/default/img/avatar3.jpg" alt="Image" class="rounded-circle">
								<small> - 10 March 2015 -</small>
								<h4>Jhon Doe</h4>
								<p>
									"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
