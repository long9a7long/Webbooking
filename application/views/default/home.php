<div class="container margin_60">
      ...
      <div class="container margin_60">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <p>
              <a href="#"><img src="<?php echo base_url(); ?>assets/default/img/bus.jpg" alt="Pic" class="img-fluid"></a>
            </p>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <p>
              <a href="#"><img src="<?php echo base_url(); ?>assets/default/img/transfer.jpg" alt="Pic" class="img-fluid"></a>
            </p>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <p>
              <a href="#"><img src="<?php echo base_url(); ?>assets/default/img/guide.jpg" alt="Pic" class="img-fluid"></a>
            </p>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <p>
              <a href="#"><img src="<?php echo base_url(); ?>assets/default/img/hotel.jpg" alt="Pic" class="img-fluid"></a>
            </p>
    ...
    <div class="container margin_60">
      ...
      <div class="row">
        <div class="col-md-6">
          <img src="<?php echo base_url(); ?>assets/default/img/laptop.png" alt="Laptop" class="img-fluid laptop">
        </div>
        <div class="col-md-6">
