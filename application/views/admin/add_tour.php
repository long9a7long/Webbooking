                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="form-group">
                            <label>Tiêu đề</label>
                            <input type="text" style="width: 100%;" class="form-control" id="tour_title" name="tour_title">
                        </div>
                        <div class="form-group">
                            <label>Danh mục tour</label>
                            <select class="form-control select2" name="category_tour_id" id="category_tour_id" multiple="multiple" data-placeholder="Chọn danh mục"
                                        style="width: 100%;">
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Xuất phát từ</label>
                            <input type="text" style="width: 100%;" class="form-control" id="tour_from" name="tour_from">
                        </div>
                        <div class="form-group">
                            <label>Điểm đến</label>
                            <input type="text" style="width: 100%;" class="form-control" id="tour_destination" name="tour_destination">
                        </div>
                        <div class="form-group">
                            <label>Thời gian</label>
                            <input type="text" style="width: 100%;" class="form-control" id="tour_duration" name="tour_duration" placeholder="Ví dụ: 2 ngày 1 đêm">
                        </div>
                        <div class="form-group">
                            <label>Giá</label>
                            <input type="text" style="width: 100%;" class="form-control" id="tour_price" name="tour_price" placeholder="Ví dụ: 2.000.000 VNĐ">
                        </div>
                        <div class="form-group">
                            <label>Giá khuyến mãi</label>
                            <input type="text" style="width: 100%;" class="form-control" id="tour_saving_price" name="tour_saving_price" placeholder="Ví dụ: 2.000.000 VNĐ">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="album_tour" name="album_tour" multiple="">
                    ...
                    <div class="col-lg-6 col-xs-12">  
                        <div class="form-group">
                            ...
                            <textarea style="width: 100%;" class="form-control" name="tour_except" id="tour_except"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Thông tin liên hệ đặt tour</label>
                            <textarea style="width: 100%;" class="form-control" name="tour_info_contact" id="tour_info_contact"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Keywords</label>
                            <textarea style="width: 100%;" class="form-control" name="tour_keywords" id="tour_keywords"></textarea>
                        </div>
                    </div> 
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea style="width: 100%;" class="form-control" name="tour_description" id="tour_description"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Lịch trình</label>
                            <textarea style="width: 100%;" class="form-control" name="tour_schedule" id="tour_schedule"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <button type="submit" class="custom-btn btn btn-block btn-success">Thêm</button>
                    <a href="<?php echo base_url(); ?>admin/tour" ><button type="button" class="custom-btn btn btn-block btn-danger">Hủy</button></a>
                </div>
            </form>
        </div>
    </div>
