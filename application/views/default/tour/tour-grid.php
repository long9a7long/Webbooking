					...
					<div class="row">
						<div class="col-md-6 wow zoomIn" data-wow-delay="0.7s">
							<div class="tour_container">
								...
								<div class="img_container">
									<a href="<?php echo base_url(); ?>tour/detail/abc">
										<img src="<?php echo base_url(); ?>assets/default/img/tour_box_8.jpg" width="800" height="533" class="img-fluid" alt="Image">
										<div class="short_info">
						...
						<div class="col-md-6 wow zoomIn" data-wow-delay="0.8s">
							<div class="tour_container">
								...
								<div class="img_container">
									<a href="<?php echo base_url(); ?>tour/detail/abc">
										<img src="<?php echo base_url(); ?>assets/default/img/tour_box_9.jpg" width="800" height="533" class="img-fluid" alt="Image">
										<div class="short_info">
