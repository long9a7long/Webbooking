      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>admin/tour"><i class="fa fa-circle-o"></i> Danh sách tour</a></li>
            <li><a href="<?php echo base_url(); ?>admin/tour/add"><i class="fa fa-circle-o"></i> Thêm tour mới</a></li>
            <li><a href="<?php echo base_url(); ?>admin/tour/category"><i class="fa fa-circle-o"></i> Danh mục tour</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
