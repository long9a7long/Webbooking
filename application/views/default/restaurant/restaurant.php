			...
			<div class="row">
				<aside class="col-lg-3">
					...
					<div class="box_style_2">
						...
						<h4>Bạn cần <span>sự giúp đỡ?</span></h4>
					...
					<div id="tools">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-4 d-none d-sm-block text-right">
								<a href="<?php echo base_url();?>restaurant/?view=2" class="bt_filters"><i class="icon-th"></i></a> <a href="#" class="bt_filters"><i class="icon-list"></i></a>
							</div>
