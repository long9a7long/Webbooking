		...
		<div id="position">
			<div class="container">
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>">Category</a>
					</li>
					<li>Page active</li>
				</ul>
			</div>
					...
					<div id="filters_col">
						...
						<div class="collapse show" id="collapseFilters">
							...
							<div class="filter_type">
								<h6>Facility</h6>
								<ul>
									<?php foreach ($list_facility as $item){
									?>
									<li>
										<label>
											<input type="checkbox" class="filter-facility" data-id="<?php echo $item['conv_id']; ?>" data-content="<?php echo $item['conv_name']; ?>"><?php echo $item['conv_name'];?> 
										</label>
									</li>
									<?php } ?>
								</ul>
